<?php
     ...
     */
      ...
      $curso=isset($_POST['curso'])?$_POST['curso']:"Compu";
      $tipo=isset($_POST['tipo'])?$_POST['tipo']:"Prova";
    
   // echo($tipo);
      $strsql="SET NAMES 'utf8';";
      inserir($strsql);
      $strsql="SELECT * FROM `tbl_pdf_provas` WHERE ano like('%$anoAtual%') and curso like('%$curso%') and tipo like('%$tipo%') and ativo=true";
      //echo($strsql);   
      carregadados($strsql);
