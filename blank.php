...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php include 'connections/conexaoDAOhomolog.php'; ?> 
                    <div class="container">
                         <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive" id="tableProva">
            ...
            <!-- End of Main Content -->
                   ...
                   <!-- <embed 
                        src="http://download.inep.gov.br/download/superior/2004/enade/provas/AGRONOMIA.pdf" 
    ...
    <script src="js/form_entrada.js"></script>
